...
export type UserState = { subscriptionStatus: string; subscriptionCurrentPeriodEnd: string | null; nutritionAccess: boolean; billingAvailable: boolean; checkoutAvailable: boolean };
