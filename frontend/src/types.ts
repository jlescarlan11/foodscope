...
export type UserState = { email: string; subscriptionStatus: string; subscriptionCurrentPeriodEnd: string | null; nutritionAccess: boolean; billingAvailable: boolean };
