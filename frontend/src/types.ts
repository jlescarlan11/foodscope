...
export type UserState = { nutritionAccess: boolean; billingAvailable: boolean; checkoutAvailable: boolean };
export type RecentSearch = { id: number; query: string; locale: string };
